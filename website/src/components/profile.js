...
<div className="bg-slate-100 h-[100vh]">
 <div className="w-full text-white bg-slate-600">
        <div
            ...
            <nav className={(!nav)?"flex-col flex-grow pb-4 md:pb-0 hidden md:flex md:justify-end md:flex-row":"flex-col flex-grow pb-4 md:pb-0 md:flex md:justify-end md:flex-row"}>
                <div className="relative">
                    <button onClick={() => setUp(!up)}
                        className="flex flex-row items-center space-x-2 w-full px-4 py-2 mt-2 text-sm font-semibold text-left bg-transparent hover:bg-blue-800 md:w-auto md:inline md:mt-0 md:ml-4 focus:bg-blue-800 focus:outline-none focus:shadow-outline">
                        <span>Jane Doe</span>
                    ...
                    <div
                        className={(up)?"absolute right-0 w-full mt-2 origin-top-right rounded-md shadow-lg md:w-48":"hidden"}>
